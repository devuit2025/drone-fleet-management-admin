...
export function ringFromFeatureCollection(fc: FeatureCollection<Polygon> | null | undefined): number[][] {
...
): Array<{ seqNumber: number; geoPoint: string; altitudeM: number; speedMps: number; action: string }> {
